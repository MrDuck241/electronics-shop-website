...
const LoginPage = () => {
    ...
    const handleLogin = async (event: any) => {
        ...
        try {
            const registerApiUrl = import.meta.env.VITE_LOGIN_API_URL;
    ...
    return (
        <div className="loginpage-container w-[100%] flex flex-col justify-center items-center">
            <div className="h-[800px] w-[70%] bg-black mt-4 mb-4 flex flex-col items-center justify-center">
                <div className="w-[40%] h-[70%] bg-gray-800 border-2 rounded-xl flex flex-col items-center pt-[10px]">
                    <span className="text-cyan-400 font-bold text-2xl">Log in to your account</span>
                    <form onSubmit={handleLogin} className="border-2 border-gray-400 rounded-2xl w-[90%] h-[80%] bg-gray-900 flex flex-col items-center justify-evenly mt-[15px]">
                        ...
                        <button type="submit" className="bg-cyan-500 text-white font-bold py-2 px-4 rounded mt-4 hover:bg-cyan-900 hover:scale-105">Log in</button>

                        {loginStatus && (
                            <span className="text-green-500 text-sm mt-2">{loginStatus}</span>
                        )}
                    </form>
                </div>
            </div>
